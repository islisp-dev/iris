...
(defmethod f ((x C) (y C) (z C))
                 ...
                 (f (create (class C))
                    (create (class C))
                    (create (class C11))))
(defmethod f ((x C) (y C) (z C11))
                 (format (standard-output) "call with ~A ~A ~A~%" 'C 'C 'C11)
                 (f (create (class C))
                    (create (class C11))
                    (create (class C))))
(defmethod f ((x C) (y C11) (z C))
                 (format (standard-output) "call with ~A ~A ~A~%" 'C 'C11 'C)
                 (f (create (class C11))
                    (create (class C))
                    (create (class C))))
(defmethod f ((x C11) (y C) (z C))
                 (format (standard-output) "call with ~A ~A ~A~%" 'C11 'C 'C)
                 (f (create (class C))
                    (create (class C11))
                    (create (class C11))))
(defmethod f ((x C) (y C11) (z C11))
                 (format (standard-output) "call with ~A ~A ~A~%" 'C 'C11 'C11)
                 (f (create (class C11))
                    (create (class C))
                    (create (class C11))))
(defmethod f ((x C11) (y C) (z C11))
                 (format (standard-output) "call with ~A ~A ~A~%" 'C11 'C 'C11)
                 (f (create (class C11))
                    (create (class C11))
                    (create (class C))))
(defmethod f ((x C11) (y C11) (z C))
                 (format (standard-output) "call with ~A ~A ~A~%" 'C11 'C11 'C)
                 (f (create (class C11))
                    (create (class C11))
                    (create (class C11))))
(defmethod f ((x C11) (y C11) (z C11))
