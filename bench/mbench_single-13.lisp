...
(defmethod f ((x C) (y C) (z C))
                 ...
                 (f (create (class C))
                    (create (class C))
                    (create (class C13))))
(defmethod f ((x C) (y C) (z C13))
                 (format (standard-output) "call with ~A ~A ~A~%" 'C 'C 'C13)
                 (f (create (class C))
                    (create (class C13))
                    (create (class C))))
(defmethod f ((x C) (y C13) (z C))
                 (format (standard-output) "call with ~A ~A ~A~%" 'C 'C13 'C)
                 (f (create (class C13))
                    (create (class C))
                    (create (class C))))
(defmethod f ((x C13) (y C) (z C))
                 (format (standard-output) "call with ~A ~A ~A~%" 'C13 'C 'C)
                 (f (create (class C))
                    (create (class C13))
                    (create (class C13))))
(defmethod f ((x C) (y C13) (z C13))
                 (format (standard-output) "call with ~A ~A ~A~%" 'C 'C13 'C13)
                 (f (create (class C13))
                    (create (class C))
                    (create (class C13))))
(defmethod f ((x C13) (y C) (z C13))
                 (format (standard-output) "call with ~A ~A ~A~%" 'C13 'C 'C13)
                 (f (create (class C13))
                    (create (class C13))
                    (create (class C))))
(defmethod f ((x C13) (y C13) (z C))
                 (format (standard-output) "call with ~A ~A ~A~%" 'C13 'C13 'C)
                 (f (create (class C13))
                    (create (class C13))
                    (create (class C13))))
(defmethod f ((x C13) (y C13) (z C13))
