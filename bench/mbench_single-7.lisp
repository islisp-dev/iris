...
(defmethod f ((x C) (y C) (z C))
                 ...
                 (f (create (class C))
                    (create (class C))
                    (create (class C7))))
(defmethod f ((x C) (y C) (z C7))
                 (format (standard-output) "call with ~A ~A ~A~%" 'C 'C 'C7)
                 (f (create (class C))
                    (create (class C7))
                    (create (class C))))
(defmethod f ((x C) (y C7) (z C))
                 (format (standard-output) "call with ~A ~A ~A~%" 'C 'C7 'C)
                 (f (create (class C7))
                    (create (class C))
                    (create (class C))))
(defmethod f ((x C7) (y C) (z C))
                 (format (standard-output) "call with ~A ~A ~A~%" 'C7 'C 'C)
                 (f (create (class C))
                    (create (class C7))
                    (create (class C7))))
(defmethod f ((x C) (y C7) (z C7))
                 (format (standard-output) "call with ~A ~A ~A~%" 'C 'C7 'C7)
                 (f (create (class C7))
                    (create (class C))
                    (create (class C7))))
(defmethod f ((x C7) (y C) (z C7))
                 (format (standard-output) "call with ~A ~A ~A~%" 'C7 'C 'C7)
                 (f (create (class C7))
                    (create (class C7))
                    (create (class C))))
(defmethod f ((x C7) (y C7) (z C))
                 (format (standard-output) "call with ~A ~A ~A~%" 'C7 'C7 'C)
                 (f (create (class C7))
                    (create (class C7))
                    (create (class C7))))
(defmethod f ((x C7) (y C7) (z C7))
