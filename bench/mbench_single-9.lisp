...
(defmethod f ((x C) (y C) (z C))
                 ...
                 (f (create (class C))
                    (create (class C))
                    (create (class C9))))
(defmethod f ((x C) (y C) (z C9))
                 (format (standard-output) "call with ~A ~A ~A~%" 'C 'C 'C9)
                 (f (create (class C))
                    (create (class C9))
                    (create (class C))))
(defmethod f ((x C) (y C9) (z C))
                 (format (standard-output) "call with ~A ~A ~A~%" 'C 'C9 'C)
                 (f (create (class C9))
                    (create (class C))
                    (create (class C))))
(defmethod f ((x C9) (y C) (z C))
                 (format (standard-output) "call with ~A ~A ~A~%" 'C9 'C 'C)
                 (f (create (class C))
                    (create (class C9))
                    (create (class C9))))
(defmethod f ((x C) (y C9) (z C9))
                 (format (standard-output) "call with ~A ~A ~A~%" 'C 'C9 'C9)
                 (f (create (class C9))
                    (create (class C))
                    (create (class C9))))
(defmethod f ((x C9) (y C) (z C9))
                 (format (standard-output) "call with ~A ~A ~A~%" 'C9 'C 'C9)
                 (f (create (class C9))
                    (create (class C9))
                    (create (class C))))
(defmethod f ((x C9) (y C9) (z C))
                 (format (standard-output) "call with ~A ~A ~A~%" 'C9 'C9 'C)
                 (f (create (class C9))
                    (create (class C9))
                    (create (class C9))))
(defmethod f ((x C9) (y C9) (z C9))
