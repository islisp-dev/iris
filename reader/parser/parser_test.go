...
func Test_parseAtom(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			name:    "signed",
			args:    args{"-5.0"},
			want:    class.New(class.Float, -5.0),
			wantErr: false,
		},
		{
			name:    "exponential",
			args:    args{"-5.0E3"},
			want:    class.New(class.Float, -5.0*1000),
			wantErr: false,
		},
		{
			name:    "signed exponential",
			args:    args{"5.0E-3"},
			want:    class.New(class.Float, 5.0*1.0/1000.0),
			wantErr: false,
		},
		{
			name:    "without point",
		...
		//
		{
			name:    "default",
			args:    args{"5"},
			want:    class.New(class.Integer, 5),
			wantErr: false,
		},
		{
			name:    "signed",
		...
		},
		{
			name:    "octal",
			args:    args{"#o00101"},
			want:    class.New(class.Integer, 65),
			wantErr: false,
		},
		{
			name:    "signed octal",
		...
		},
		{
			name:    "hexadecimal",
			args:    args{"#X00101"},
			want:    class.New(class.Integer, 257),
			wantErr: false,
		},
		{
		...
		//
		{
			name:    "default",
			args:    args{"#\\a"},
			want:    class.New(class.Character, 'a'),
			wantErr: false,
		},
		{
			name:    "newline",
