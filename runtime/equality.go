...
func Eq(local environment.Environment, obj1, obj2 ilos.Instance) (ilos.Instance, ilos.Instance) {
...
// Two objects are the same if there is no operation that could distinguish
// them (without modifying them), and if modifying one would modify the other the same way.
func Eql(local environment.Environment, obj1, obj2 ilos.Instance) (ilos.Instance, ilos.Instance) {
...
func Equal(local environment.Environment, obj1, obj2 ilos.Instance) (ilos.Instance, ilos.Instance) {
